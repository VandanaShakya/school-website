...
const testimonials = [
  {
    ...
    text: "Kids School has transformed my daughter's love for learning. The teachers are exceptional and the environment is so nurturing!",
    avatar: "SJ",
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <p className="section-subtitle mb-6">
                Founded in 1999, Kids School has been a beacon of excellence in education. We combine rigorous academics with creative exploration to develop well-rounded, confident young learners.
              </p>
